...
$config['hosts'] = array('192.168.100.203');
$config['ports'] = array(389);
$config['basedn'] = 'dc=nkmz,dc=plant';
$config['login_attribute'] = 'cn';
$config['proxy_user'] = 'cn=admin,dc=nkmz,dc=plant';
$config['proxy_pass'] = 'root';
// $config['proxy_pass'] = 'Ytantrfvcr2007,Flvby';
